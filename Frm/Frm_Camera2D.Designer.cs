namespace HardWareNet.Frm
{
  partial class Frm_Camera2D
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.user_ShowDisplay = new VisonCore.ShowFrm.ShowDisplayFrm();
      ...
      // user_ShowDisplay
      // 
      this.user_ShowDisplay.ContinuousShowImage = null;
      ...
      this.user_ShowDisplay.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
      this.user_ShowDisplay.Name = "user_ShowDisplay";
      this.user_ShowDisplay.ShowDisplayName = "显示";
      this.user_ShowDisplay.ShowImage = null;
      this.user_ShowDisplay.ShowRecord = null;
    ...
    private VisonCore.ShowFrm.ShowDisplayFrm user_ShowDisplay;
  }
}